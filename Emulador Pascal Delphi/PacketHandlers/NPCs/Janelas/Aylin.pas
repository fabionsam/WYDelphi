...
begin
	...
	3: Segundo add (diferente da refinação) da segunda + primeiro add(diferente da refinação) da primeira
	4: Segundo add (diferente da refinação) da primeira + primeiro add(diferente da refinação) da segunda
	}
