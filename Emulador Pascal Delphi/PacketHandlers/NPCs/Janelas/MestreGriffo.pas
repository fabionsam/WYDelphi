...
Uses MiscData, PlayerData, ItemFunctions, Functions, Position,
...
var packet : TMestreGriffo absolute buffer; dest: TPosition;
begin
  result := False;
  ...
  if(packet.WarpType = 1)then
    ...
    begin
      ...
      dest.X := 2112;
      dest.Y := 2051;
      TFunctions.GetEmptyMobGrid(player.ClientId, dest);
